...
class ToolbarView : public views::AccessiblePaneView,
 ...
 private:
  ...
  // Neural-Chromium: Input Logic
  void InitNeuralInput();
  void OnNeuralInputTimer();
  ...
  raw_ptr<ToolbarButton> neural_agent_button_ = nullptr;
  
  // Neural-Chromium: Input State
  base::RepeatingTimer input_timer_;
  RAW_PTR_EXCLUSION void* input_shm_handle_ = nullptr; // HANDLE
  RAW_PTR_EXCLUSION void* input_shm_view_ = nullptr;   // Mapped View
  bool neural_agent_active_ = false;
